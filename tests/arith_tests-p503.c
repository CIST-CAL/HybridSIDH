...
// Benchmark and test parameters  
    ...
    #define BENCH_LOOPS           10000000       // Number of iterations per bench
    #define SMALL_BENCH_LOOPS     10000000       // Number of iterations per bench
    #define TEST_LOOPS             10000000       // Number of iterations per test
#else
    #define BENCH_LOOPS        10000000 
    #define SMALL_BENCH_LOOPS   10000000       
