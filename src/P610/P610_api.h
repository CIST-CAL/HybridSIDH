...
int Hy_crypto_kem_keypair_SIKEp610(unsigned char *pk, unsigned char *sk);
...
int Hy_crypto_kem_enc_SIKEp610(unsigned char *ct, unsigned char *ss, const unsigned char *pk);
// SIKE's decapsulation
// Input:   secret key sk         (CRYPTO_SECRETKEYBYTES = 524 bytes)
//          ciphertext message ct (CRYPTO_CIPHERTEXTBYTES = 486 bytes) 
// Outputs: shared secret ss      (CRYPTO_BYTES = 24 bytes)

int Hy_crypto_kem_dec_SIKEp610(unsigned char *ss, const unsigned char *ct, const unsigned char *sk);
...
int Hy_KeyGeneration_A_SIDHp610(const unsigned char* PrivateKeyA, unsigned char* PublicKeyA);
...
int Hy_KeyGeneration_B_SIDHp610(const unsigned char* PrivateKeyB, unsigned char* PublicKeyB);
...
int Hy_SecretAgreement_A_SIDHp610(const unsigned char* PrivateKeyA, const unsigned char* PublicKeyB, unsigned char* SharedSecretA);
...
int Hy_SecretAgreement_B_SIDHp610(const unsigned char* PrivateKeyB, const unsigned char* PublicKeyA, unsigned char* SharedSecretB);
